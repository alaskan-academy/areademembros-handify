...
/**
 * Cadastro que vem de `/comecar` (ferramentas grátis): mesmos campos, sem CPF.
 * O CPF é pedido quando ela compra um curso, que é quando ele serve para algo
 * (certificado). Exigir antes só afasta quem ainda nem experimentou.
 */
